...
import com.robototes.logging.shuffleboard.AbstractConfigurable;
 ...
 */
public abstract class NumberConfig<S extends NumberConfig<S>> extends AbstractConfigurable<Double, S> {
